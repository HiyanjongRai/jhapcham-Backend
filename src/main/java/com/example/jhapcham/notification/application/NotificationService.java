package com.example.jhapcham.notification.application;
...
public class NotificationService {
    ...
    public void notifyAllSellers(String title, String message, Long relatedEntityId) {
        List<User> sellers = userRepository.findByRole(com.example.jhapcham.user.domain.Role.SELLER);
    ...
    public void notifyAllCustomers(String title, String message, Long relatedEntityId) {
        List<User> customers = userRepository.findByRole(com.example.jhapcham.user.domain.Role.CUSTOMER);
     ...
     * Used by the scheduler to alert admins about stuck or overdue refunds.
     */
    @Transactional
    public void broadcastToAdmins(String title, String message, NotificationType type, Long relatedEntityId) {
        List<User> admins = userRepository.findByRole(com.example.jhapcham.user.domain.Role.ADMIN);
        for (User admin : admins) {
            createNotification(admin, title, message, type, relatedEntityId);
        }
    }
}
