...
public class SmsController {
    ...
    public ResponseEntity<?> updateSmsPreferences(
        ...
        try {
            ...
            if (dto.getRefundAlerts() != null) preference.setRefundAlerts(dto.getRefundAlerts());
            if (dto.getDisputeAlerts() != null) preference.setDisputeAlerts(dto.getDisputeAlerts());
    ...
    private SmsPreferenceDTO toDTO(SmsPreference preference) {
        return SmsPreferenceDTO.builder()
                ...
                .refundAlerts(preference.getRefundAlerts())
                .disputeAlerts(preference.getDisputeAlerts())
