package com.example.jhapcham.activity.application;


import com.example.jhapcham.activity.application.*;
import com.example.jhapcham.activity.api.UserActivityController;
...
import com.example.jhapcham.product.persistence.ProductViewRepository;
...
public class UserActivityService {
    ...
    public List<UserActivityController.UserActivityResponseDTO> getUserActivitiesWithProductNames(Long userId) {
        ...
        Map<Long, String> productNames = productRepository.findAllById(productIds).stream()
                .collect(Collectors.toMap(com.example.jhapcham.product.domain.Product::getId,
                        com.example.jhapcham.product.domain.Product::getName));
